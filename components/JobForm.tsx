...
import type { Job, Client, Cleaner } from '@/types/airtable';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const jobData: Partial<Job['fields']> = {
        ...
        Cleaner: formData.cleaner ? [formData.cleaner] : undefined,
        Date: formData.date,
        Time: formData.time,
            ...
            >
              ...
              {cleaners.map(cleaner => (
                <option key={cleaner.id} value={cleaner.id}>
                  {cleaner.fields.Name} - ${cleaner.fields['Hourly Rate']}/hr
                </option>
              ))}
            </select>
          </div>
